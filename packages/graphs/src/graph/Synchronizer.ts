...
export class Synchronizer {
    ...
    synchronize = (): { detach: Function; graphs: Array<Dygraph[]> } => {
        ...
        if (this.args[0] instanceof Dygraph) {
            ...
            if (i < this.args.length - 1) {
                throw new Error('Invalid invocation of Dygraph.synchronize(). All but the last argument must be Dygraph objects.');
            ...
            if (this.args.length === 2) {
                ...
                throw new Error('Invalid invocation of Dygraph.synchronize(). Expected two arguments: array and optional options argument.');
            } // otherwise arguments.length == 1, which is fine.
        } else {
            throw new Error('Invalid invocation of Dygraph.synchronize(). First parameter must be either Dygraph or list of Dygraphs.');
        }
